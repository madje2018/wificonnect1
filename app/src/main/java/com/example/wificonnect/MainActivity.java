...
public class MainActivity extends AppCompatActivity {
    private static final String LOG_TAG = "WifiConnect";
    ...
    public void  onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults){
        ...
        switch (requestCode)  {
            case MY_REQUEST_CODE:  {
                // Si la requête est annulée, le tableau de résultat est vide
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)  {
                    ...
                    // Permission refusée,  Désactiver la
                    // fonctionalité qi dépend de cette permission.
    ...
    private void showNetworks(List<ScanResult> results) {
        ...
        for( final ScanResult result: results)  {
            ...
            final String networkSSID = result.SSID; // Nom d réseau.
            //
    ...
    private void connectToNetwork(String networkCapabilities, String networkSSID)  {
        Toast.makeText(this, "Connection au réseau: "+ networkSSID, Toast.LENGTH_SHORT).show();
        ...
        if(networkCapabilities.toUpperCase().contains("WEP")) { // WEP Network.
            ...
            Toast.makeText(this, "ACCES RESEAU", Toast.LENGTH_SHORT).show();
            wifiConfig.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
        }
    ...
    private void showNetworksDetails(List<ScanResult> results)  {
        ...
        for(int i = 0; i < results.size(); i++ )  {
            ...
            sb.append("\n result.SSID: " + result.SSID); // Nom du réseau.
